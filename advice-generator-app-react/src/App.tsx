...
function App() {
  ...
  const [advice, setAdvise] = useState("It's easy to sit up and take notice. What's difficult is getting up and taking action.It's easy to sit up and take notice. What's difficult is getting up and taking action.It's easy to sit up and take notice. What's difficult is getting up and taking action.");
  ...
  return (
    <div className="bg-gray-800 grid place-items-center h-screen text-center">
      <div>
        ...
        <div className='text-white relative bottom-0'>
          Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank" rel="noreferrer">Frontend Mentor</a>.
          Coded by <a href="https://stackoverflow.com/users/7289093/tariq-imtinan">Tariq Imtinan</a>.
        </div>
      </div>
    </div>
  );
